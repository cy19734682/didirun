  ...
  <view>
    <dd-card padding="30rpx" width="626rpx">
      <view class="flex flex-start item-center mb-28" @click="navToCity()">
        <view class="iconfont icon-local fo-32"> </view>
        <view class="fo-28 ml-16">
          所在城市：{{ city }}
          <text v-if="!isOp" class="fo-9 fo-24">(该城市暂未开通运营)</text>
        </view>
      </view>
      ...
      <AddressBtn
        ...
        dot="green"
        placeholder="到哪里拿货"
        :type="tabCurrent === HELP_BUY ? 'radio' : 'default'"
...
import { HELP_DELIVER, HELP_BUY, HELP_GET } from "../../../util/constant.js";
