<template>
  <view class="address-config border-t border-b">
    <!-- 家 -->
    <view
      class="address-container flex flex-between item-center border-b"
      @click="chooseAddress('home')"
    >
      <view class="iconfont icon-home fo-40 fo-9"> </view>
      <view class="address-content">
        <view class="fo-32 bold"> 家 </view>
        <view v-if="home.province">
          <view class="fo-28 mt-16 fo-6 ell">
            {{ home.province }}{{ home.city }}{{ home.district
            }}{{ home.addressDetail }}
          </view>
          <view class="fo-28 mt-16 fo-6 ell">
        ...
        <view v-else>
          <view class="fo-28 mt-16 fo-9"> 设置家的地址 </view>
          <view class="fo-28 mt-16 fo-9"> 设置联系方式 </view>
        </view>
      </view>
    ...
    <!-- 企业 -->
    <view
      class="address-container flex flex-between item-center"
      @click="chooseAddress('company')"
    >
      <view class="iconfont icon-company fo-40 fo-9"> </view>
      <view class="address-content">
        <view class="fo-32 bold"> 公司 </view>
        ...
        <view v-else>
          <view class="fo-28 mt-16 fo-9"> 设置公司的地址 </view>
          <view class="fo-28 mt-16 fo-9"> 设置联系方式 </view>
        </view>
      </view>
    ...
    navToSupply(type) {
      uni.navigateTo({
        url: `/pages/mine/address/supply/supply?type=${type}&address=${
          this[type].province ? JSON.stringify(this[type]) : ""
        }`,
      });
    },
    chooseAddress(type) {
