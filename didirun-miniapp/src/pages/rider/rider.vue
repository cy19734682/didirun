  ...
  <view class="p-30">
    <view class="rider-panel flex flex-start flex-wrap rider-panel-t">
      <view class="rider-data-item">
        <view class="fo-32 fo-w"> {{ balance }}元 </view>
        <view class="fo-24 fo-w mt-8"> 余额 </view>
      </view>
      <view class="rider-data-item">
        <view class="fo-32 fo-w"> {{ accumulatedCash }}元 </view>
        <view class="fo-24 fo-w mt-8"> 已提现 </view>
      </view>
      <view class="rider-data-item">
        <view class="fo-32 fo-w"> {{ accumulatedIncome }}元 </view>
        <view class="fo-24 fo-w mt-8"> 累计收入 </view>
      </view>
    </view>

    <view class="rider-panel flex flex-start flex-wrap rider-panel-i mt-32">
      <view class="rider-data-item">
        <view class="fo-32 fo-w"> {{ todayTotal }}单 </view>
        <view class="fo-24 fo-w mt-8"> 今日成单 </view>
      </view>
      <view class="rider-data-item">
        <view class="fo-32 fo-w"> {{ monthTotal }}单 </view>
        <view class="fo-24 fo-w mt-8"> 本月成单 </view>
      </view>
      <view class="rider-data-item">
        <view class="fo-32 fo-w"> {{ allTotal }}单 </view>
        <view class="fo-24 fo-w mt-8"> 累计成单 </view>
      </view>
    </view>
    ...
    <dd-card margin="30rpx 0 0 0">
      ...
      >
        <view class="flex flex-start item-center">
          <view class="iconfont icon-setting fo-28"> </view>
          <view class="ml-30 fo-28"> 骑手设置 </view>
        </view>
        <view class="iconfont icon-arrow-right fo-28 fo-9"> </view>
      </navigator>
      <navigator
      ...
      >
        <view class="flex flex-start item-center">
          <view class="iconfont icon-status fo-28"> </view>
          <view class="ml-30 fo-28"> 骑手状态 </view>
        </view>
        <view class="iconfont icon-arrow-right fo-28 fo-9"> </view>
      </navigator>
    </dd-card>
