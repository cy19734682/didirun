<template>
  <view>
    <view v-if="ing.length > 0">
      <view class="normal-tag"> 进行中的订单 </view>
      <view class="p-30">
    ...
    <view v-if="list.length > 0">
      <view class="normal-tag"> 已完成的订单 </view>
      <view class="p-30">
    ...
    <view
      v-if="list.length === 0 && ing.length === 0 && !loading"
      class="empty text-center flex flex-center item-center"
    >
      <view>
        <view class="iconfont icon-order-empty fo-none"> </view>
        <view class="mt-32 fo-24 fo-none"> 您还没有订单 </view>
      </view>
    </view>
  </view>
</template>
