    ...
    <div class="edit-content">
      <a-form-model ref="ruleForm" :model="formData" :rules="rules">
        <a-form-model-item ref="realName" label="头像">
          <upload v-model="formData.avatarUrl" :width="100" :height="100" />
        </a-form-model-item>

        <a-form-model-item label="真实姓名" prop="realName">
          <a-input v-model="formData.realName" :maxLength="45" placeholder="请输入真实姓名" />
        </a-form-model-item>

        <a-form-model-item label="手机号" prop="mobileNumber">
          <a-input v-model="formData.mobileNumber" :maxLength="11" placeholder="请输入手机号" />
        </a-form-model-item>
