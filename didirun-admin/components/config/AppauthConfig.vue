<template>
  <div class="config-content">
    <a-form-model ref="ruleForm" :model="formData" :rules="rules">
      ...
      <a-divider></a-divider>
      <div class="flex flex-between item-center">
        <div class="bold">字节跳动小程序配置</div>
        <a
          href="https://microapp.bytedance.com/docs/zh-CN/mini-app/introduction/plug-in/mini-app-developer/pre-develop"
          target="_blank"
          >帮助</a
        >
      </div>
      <a-form-model-item label="小程序ID">
        <a-input v-model="formData.ttAppid" placeholder="请输入qq小程序ID" />
      </a-form-model-item>

      <a-form-model-item label="小程序秘钥">
        <a-input v-model="formData.ttAppSecret" placeholder="请输入小程序秘钥" />
      </a-form-model-item>
